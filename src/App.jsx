...
function App() {
  ...
  useEffect(() => {
    MySwal.fire({
      ...
      html:'<p>If you have dice icon/image for the rest of the dice, mention @au in Playmates server. '+
      '<br><br> Click dice <b>ICON</b> to add, Click dice <b>NAME</b> to subtract (in case u miss clicked)</p>'+
      '<br><br> Most of images rescaled by JUS_KTH'
    })
  }, []);
